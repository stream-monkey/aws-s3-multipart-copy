 ...
 */
let copyObjectMultipart = async function ({ source_bucket, object_key, destination_bucket, copied_object_name, object_size, copy_part_size_bytes, copied_object_permissions, copied_object_metadata, copied_object_contenttype, expiration_period }, request_context) {
    let upload_id = await initiateMultipartCopy(destination_bucket, copied_object_name, copied_object_permissions, copied_object_metadata, copied_object_contenttype, expiration_period, request_context);
...
function initiateMultipartCopy(destination_bucket, copied_object_name, copied_object_permissions, copied_object_metadata, copied_object_contenttype, expiration_period, request_context) {
    let params = {
